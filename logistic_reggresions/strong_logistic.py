...
def strong_logistic(games, logistic_input, xin, original_input):
    ...
    if games <= 15:
        ...
        clf15CV = LogisticRegressionCV(solver='lbfgs', max_iter=1000, cv=5).fit(logistic_input15, y_15)
        ...
        clf35CV = LogisticRegressionCV(solver='lbfgs', max_iter=1000, cv=5).fit(logistic_input35, y_35)
        ...
        clfRest_CV = LogisticRegressionCV(solver='lbfgs', max_iter=400, cv=5).fit(logistic_inputRest, y_Rest)
